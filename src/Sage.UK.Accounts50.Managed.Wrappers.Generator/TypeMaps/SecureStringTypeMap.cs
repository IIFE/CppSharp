...
namespace Sage.UK.Accounts50.Managed.Wrappers.Generator.TypeMaps
{
    ...
    /// </summary>
    [TypeMap("basic_string<char, char_traits<char>, SecureCharAllocator<char>>")]
    internal class SecureStringTypeMap : TypeMap
    {
        /// <summary>
        ...
        {
            ctx.Return.Write($"msclr::interop::marshal_as<System::String^>({ctx.ReturnVarName}.c_str())");
        }
        ...
        public override void CLIMarshalToNative(MarshalContext ctx)
        {
            ...
            ctx.Return.Write($"SecurityLib::securestring(_{ctx.ArgName}.c_str())");
        }
    }
}
